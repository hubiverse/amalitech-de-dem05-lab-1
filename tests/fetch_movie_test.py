...
from utils import fetch_movie_by_id, movie_url


@pytest.mark.asyncio
@respx.mock
async def test_fetch_movie_happy_path(mock_settings, client, semaphore):
    """
    ...
    movie = await fetch_movie_by_id(client, mock_settings, movie_id, semaphore=semaphore)
...
@pytest.mark.asyncio
@respx.mock
async def test_fetch_movie_hard_error_no_retry(mock_settings, client, semaphore):
    """
    ...
    movie = await fetch_movie_by_id(client, mock_settings, movie_id, semaphore=semaphore, max_retries=3)
...
@pytest.mark.asyncio
@respx.mock
async def test_fetch_movie_soft_error_retry_success(mock_settings, client, semaphore):
    """
    ...
    movie = await fetch_movie_by_id(client, mock_settings, movie_id, semaphore=semaphore, max_retries=2,
                                    wait_factor=0.1)
...
@respx.mock
async def test_max_retries_logic(mock_settings, client, max_retries, expected_calls, semaphore):
    """
    ...
    movie = await fetch_movie_by_id(client, mock_settings, movie_id, semaphore=semaphore, max_retries=max_retries,
                                    wait_factor=0.01)
